...
import com.chefswithoutlimits.customerchef.activity.chefs.order.ChefOrderDetailsActivity;
import com.chefswithoutlimits.customerchef.adapter.ChefNewOrderListAdapter;
...
public class NotificationActivity extends Activity {
   ...
   /* private static final String TAG = NotificationActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfo = Sharepreferences.getSharePreferance(NotificationActivity.this);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(InternetConnectivity.isConnectedFast(NotificationActivity.this)){
                    startActivity(new Intent(NotificationActivity.this,ChefDashboardActivity.class));
                    finish();
                }else {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(NotificationActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public void parseData(String response)
    {
        try {
            ...
            if(Status.equalsIgnoreCase("success")) {
                ...
                Toast.makeText(NotificationActivity.this, "No order", Toast.LENGTH_LONG).show();
            }
        ...
        listViewNewOrder.setAdapter(new ChefNewOrderListAdapter(NotificationActivity.this,alllist));
    }
    ...
    public void yourDesiredMethod(String id)
    {
        ...
        if(InternetConnectivity.isConnectedFast(NotificationActivity.this)){
            Intent intent=new Intent(NotificationActivity.this,ChefOrderDetailsActivity.class);
