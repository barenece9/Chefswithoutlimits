...
public class ChefNewOrderListAdapter extends BaseAdapter {
	...
	public ChefNewOrderListAdapter(NotificationActivity mainActivity, ArrayList<HashMap<String,String>> listitems1) {
