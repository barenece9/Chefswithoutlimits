...
public class CustomerOpenOrderAdapter extends BaseAdapter {
	...
	public CustomerOpenOrderAdapter(Context mainActivity, ArrayList<HashMap<String,String>> listitems1) {
...
*/
		...
		holder.item_details.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(context instanceof CustomerOpenOrderActivity){
					((CustomerOpenOrderActivity)context).yourDesiredMethod(id);
				}
			}
		});
		...
		holder.tn_check.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!code.equalsIgnoreCase("")) {
					...
					if (context instanceof CustomerOpenOrderActivity) {
						//((CustomerOpenOrderActivity) context).CheckSecrateCode(code);
					}
				}else {
