...
public class ChefOrderListingAdapter extends BaseAdapter {
	...
	public ChefOrderListingAdapter(ChefOrderActivity mainActivity, ArrayList<HashMap<String,String>> listitems1) {
	...
	{
		CardView ll_bg;
		TextView invoiceno,total_amont,datetime_added,order_type,schedule_date,tn_check,item_details,item_details_bill;
		EditText etn_code;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View rowView;
		rowView = inflater.inflate(R.layout.infleter_chef_new_order, null);
		...
		if(order_status.equalsIgnoreCase("draft")){
			...
			holder.ll_bg.setBackgroundColor(Color.parseColor("#1dc499"));//#1dc499  #1dc499
			//holder.ll_bg.setBackgroundResource(R.drawable.deliver_ractangle_bg);
			//holder.schedule_date.setVisibility(View.GONE);
			holder.etn_code.setVisibility(View.GONE);
			holder.tn_check.setVisibility(View.GONE);
		}else if(order_status.equalsIgnoreCase("pending")){
			//holder.ll_bg.setBackgroundResource(R.drawable.panding_ractangle_bg);
			holder.ll_bg.setBackgroundColor(Color.parseColor("#a71e22")); //#a71e22
		}else {
...
*/
		...
		holder.item_details.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				System.out.println("Click Order Details, Order ID : "+id);
				if(context instanceof ChefOrderActivity){
					//((ChefOrderActivity)context).yourDesiredMethod(id);
					((ChefOrderActivity)context).OrderDetails(id);
				}
			}
		});

		holder.item_details_bill.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				String id=listitems.get(position).get("id");
