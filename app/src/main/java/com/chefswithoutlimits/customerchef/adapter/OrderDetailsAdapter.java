...
public class OrderDetailsAdapter extends BaseAdapter {
    ...
    public OrderDetailsAdapter(ShippingScreen mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.order_dialiog_list_item, null);
            ...
            public void onClick(View v) {
               quantity=Integer.valueOf(listitems.get(position).get("quantity"));
                ...
                if(context instanceof CartListActivity){
                    ((CartListActivity)context).updatecartmenu(cart_id);
                }
        ...
        holder.btn_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity<=0) {
                    ...
                    //String menu_id=listitems.get(position).get("menu_id");
                    if(context instanceof CartListActivity){
                        ((CartListActivity)context).updatecartmenudec(cart_id);
                    }
                }
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String cart_id=listitems.get(position).get("cart_id");
                if(context instanceof CartListActivity){
                    ((CartListActivity)context).deletecartmenu(cart_id);
                }
            }
        });
