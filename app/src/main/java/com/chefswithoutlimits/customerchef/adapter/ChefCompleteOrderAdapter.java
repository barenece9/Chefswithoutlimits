...
public class ChefCompleteOrderAdapter extends BaseAdapter {
	...
	public ChefCompleteOrderAdapter(ChefCompleteOrderActivity mainActivity, ArrayList<HashMap<String,String>> listitems1) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View rowView;
		rowView = inflater.inflate(R.layout.infleter_chef_complete_order, null);
		...
		/*holder.item_details.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(context instanceof ChefOrderActivity){
					((NotificationActivity)context).yourDesiredMethod(id);
				}
			}
		});*/
		...
		holder.tn_check.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!code.equalsIgnoreCase("")) {
					...
					if (context instanceof ChefOrderActivity) {
						//((ChefCompleteOrderActivity) context).CheckSecrateCode(code);
					}
				}else {
