    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        btn_add_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(_context instanceof KitchenDetailsActivity){
                    ((KitchenDetailsActivity)_context).addtocart(menu_id);
                }
            }
        });
        ...
        btn_option.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String menu_id = parts2[3]; // 004
                if(_context instanceof KitchenDetailsActivity){
                    ((KitchenDetailsActivity)_context).callOption(menu_id);
                }
            }
        });
        ...
        if(part3.trim().equalsIgnoreCase("0")){
