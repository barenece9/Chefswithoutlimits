...
public class SearchKitchen extends Activity implements View.OnClickListener {
    ...
    void setwidgets(){
        ...
        itemlistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Sharepreferences.saveSharePreferanceKitchenData(SearchKitchen.this, kitchenData);


                if(InternetConnectivity.isConnectedFast(SearchKitchen.this)){
                    Intent intent=new Intent(SearchKitchen.this,KitchenDetailsActivity.class);
...
*/
        ...
        /*try {
            ...
            locationDialog=new ProgressDialog(SearchKitchen.this);
       ...
       /* if(!(ConstantUtils.Latitude.equalsIgnoreCase("0") || ConstantUtils.Longitude.equalsIgnoreCase("0"))){
            Log.e("Customer Search Kitchen : ","Call Get Location ");
            GetLocation(ConstantUtils.Latitude,ConstantUtils.Longitude);
        }else {
            Log.e("Customer Search Kitchen : ","Call Country List ");
            doCountryList();
        }*/
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnBack:
                ...
                if(InternetConnectivity.isConnectedFast(SearchKitchen.this)){
                    startActivity(new Intent(SearchKitchen.this,CustomerDashboardActivity.class));
                    finish();
                }else {
                    Toast.makeText(getApplicationContext(),"check your internet connection",Toast.LENGTH_SHORT).show();
                }
            ...
            case R.id.btnLogout:
                ...
                Logout.logOut(SearchKitchen.this);
                finish();
    ...
    void doCountryList()
    {
        final ProgressDialog progressDialog=new ProgressDialog(SearchKitchen.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SearchKitchen.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public void doSearchKitchenList(final String cityid){
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                UserInformation userInfo = Sharepreferences.getSharePreferance(SearchKitchen.this);
                Map<String, String>  params = new HashMap<String, String>();
    ...
    public void parseSearchKitchenList(String response)
    {
        try {
            ...
            if(Status.equalsIgnoreCase("true")) {
                ...
                Toast.makeText(SearchKitchen.this, "No kitchen registered here", Toast.LENGTH_LONG).show();
            }
        ...
        itemlistView.setAdapter(new SearchKitchenListAdapter(SearchKitchen.this,kitchenlist));
    }
    ...
    public void GetLocation(final String lat,final String lng){
        ...
        Log.e("Customer Search Kitchen : GetLocation URL :",url);
