...
import com.chefswithoutlimits.customerchef.adapter.OfflineExpandableListAdapter;
...
public class OfflineKitchenDetailsActivity extends Activity implements View.OnClickListener {
    ...
    OfflineExpandableListAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kitchen_id=ConstantUtils.kitchen_id;
        kitchenName=ConstantUtils.kitchenName;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnBack:
                ...
                if(!ConstantUtils.offlineCartStatus) {
                    ...
                    if(hasPermissionLocation) {
                        ...
                        if(InternetConnectivity.isConnectedFast(OfflineKitchenDetailsActivity.this)){
                            startActivity(new Intent(OfflineKitchenDetailsActivity.this, OfflineSearchKitchen.class));
                            finish();
                        }else {
                        ...
                        ActivityCompat.requestPermissions(OfflineKitchenDetailsActivity.this,
                                new String[]{Manifest.permission.ACCESS_FINE_LOCATION},
                                REQUEST_ACCESS_FINE_LOCATION);
                    }

                }else {
                    startActivity(new Intent(OfflineKitchenDetailsActivity.this, HomeActivity.class));
                    finish();
                }
            ...
            case R.id.imgCart:
                ...
                if(ConstantUtils.offlineCartStatus) {
                    if(InternetConnectivity.isConnectedFast(OfflineKitchenDetailsActivity.this)){
                        startActivity(new Intent(OfflineKitchenDetailsActivity.this, OfflineCartListActivity.class));
                        finish();
                    }else {
                        Toast.makeText(getApplicationContext(),"check your internet connection",Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.btnLogout:
                Logout.logOut(OfflineKitchenDetailsActivity.this);
                finish();
                break;
        }
    }
    ...
    public void getmenutable(){
        final ProgressDialog progressDialog=new ProgressDialog(OfflineKitchenDetailsActivity.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(OfflineKitchenDetailsActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public void parseKitchenMenuTable(String response)
    {
        ...
        listAdapter = new OfflineExpandableListAdapter(this, listDataHeader, listDataChild);
    ...
    public void callOption(final String menu_id){
        final ProgressDialog progressDialog2=new ProgressDialog(OfflineKitchenDetailsActivity.this);
    ...
    public  void  showdialog(final ArrayList<OptionItemValue> optionItemValues,final String menu_id){
        ...
        final Dialog dialog = new Dialog(OfflineKitchenDetailsActivity.this);
       ...
       // dialog_listView.setAdapter(new DialogOptionAdapter(KitchenDetailsActivity.this,optionlist));
        OptionArrayAdapter adapterBarcode = new OptionArrayAdapter(OfflineKitchenDetailsActivity.this,optionItemValues);
    ...
    public void addtocart(final String menu_id){
        final ProgressDialog progressDialog3=new ProgressDialog(OfflineKitchenDetailsActivity.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                userInfo = Sharepreferences.getSharePreferance(OfflineKitchenDetailsActivity.this);
                Map<String, String>  params = new HashMap<String, String>();
                params.put("customer_id",ConstantUtils.sessionUserId);
                params.put("kitchen_id",kitchen_id);
                params.put("menu_id",menu_id);
                ...
                Log.e("customer_id",ConstantUtils.sessionUserId);
                Log.e("kitchen_id",kitchen_id);
    ...
    public void addtocartafteroption(final String menu_id,final String menu_item){
        final ProgressDialog progressDialog4=new ProgressDialog(OfflineKitchenDetailsActivity.this);
    ...
    public void getcartcounter(){
        final ProgressDialog progressDialog5=new ProgressDialog(OfflineKitchenDetailsActivity.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                ...
                Log.e("user_id",ConstantUtils.sessionUserId);
                Log.e("kitchen_id",kitchen_id);
                Log.e("format","json");
