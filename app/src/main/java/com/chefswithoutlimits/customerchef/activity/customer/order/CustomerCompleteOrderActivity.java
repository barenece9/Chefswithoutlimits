...
import com.chefswithoutlimits.customerchef.adapter.CustomerClosedOrderAdapter;
...
public class CustomerCompleteOrderActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_customer_complete_order);
	...
	{
		userInfo = Sharepreferences.getSharePreferance(CustomerCompleteOrderActivity.this);
		...
		headerTxt.setText("COMPLETED ORDER");
	...
	public void onClick(View view) {
		...
		case R.id.btnBack:
			...
			if(InternetConnectivity.isConnectedFast(CustomerCompleteOrderActivity.this)){
				startActivity(new Intent(CustomerCompleteOrderActivity.this,CustomerDashboardActivity.class));
				finish();
			}else {
	...
	void getorderValue()
	{
		final ProgressDialog progressDialog=new ProgressDialog(CustomerCompleteOrderActivity.this);
			...
			public void onResponse(String response) {
				...
				new Response.ErrorListener() 
				{
					...
					public void onErrorResponse(VolleyError error) {
						...
						Toast.makeText(CustomerCompleteOrderActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
					}
				}
				){     
			@Override
	...
	public void parseData(String response)
	{
		try {
			...
			if(Status.equalsIgnoreCase("true")) {
				...
				Toast.makeText(CustomerCompleteOrderActivity.this, "No order", Toast.LENGTH_LONG).show();
			}
		...
		listViewNewOrder.setAdapter(new CustomerClosedOrderAdapter(CustomerCompleteOrderActivity.this,alllist));
	}
	...
	{
		Intent intent=new Intent(CustomerCompleteOrderActivity.this,CustomerOrderDetailsActivity.class);
		intent.putExtra("id",id);
		intent.putExtra("activity","CustomerCompleteOrderActivity");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch(resultCode) {
			...
			case StripeApp.RESULT_ERROR:
				...
				Toast.makeText(CustomerCompleteOrderActivity.this, error_description, Toast.LENGTH_SHORT).show();
				break;
		}
