...
import com.chefswithoutlimits.customerchef.adapter.OfflineCartItemDetailsAdapter;
...
public class OfflineCartListActivity extends Activity implements OnClickListener{
	...
	TextView txtCusName;
	OfflineCartItemDetailsAdapter adapter;
	...
	public void setWidget()
	{
		...
		adaptercategory = new ArrayAdapter<String>(OfflineCartListActivity.this,R.layout.spinner_rows, category);
	...
	public void onClick(View view) {
		...
		case R.id.btnBack:
			...
			if(InternetConnectivity.isConnectedFast(OfflineCartListActivity.this)){
				startActivity(new Intent(OfflineCartListActivity.this,OfflineKitchenDetailsActivity.class));
				finish();
			}else {
		...
		case R.id.btn_shoping:
			...
			if(InternetConnectivity.isConnectedFast(OfflineCartListActivity.this)){
				Intent intent=new Intent(OfflineCartListActivity.this,OfflineKitchenDetailsActivity.class);
			...
			case R.id.btn_next:
				...
				if(InternetConnectivity.isConnectedFast(OfflineCartListActivity.this)){
					RememberData userInfo=Sharepreferences.getRememberLogin(this);
					if(!userInfo.isLogin()){
						...
						if(selectcategory.equalsIgnoreCase("")) {
							...
							if(Float.valueOf(deliverydistance.replaceAll(",", ""))>=Float.valueOf(distance.replaceAll(",", ""))){
								if(ordertype.equalsIgnoreCase("IM")){
									...
									/*Intent intent2=new Intent(OfflineCartListActivity.this,ShippingScreen.class);
									startActivity(intent2);
									finish();*/
									ConstantUtils.activityLunch="ShippingScreen";
									showCheckoutDialog();
									...
									/*Intent intent1 = new Intent(OfflineCartListActivity.this, ScheduledDeliveryActivity.class);
									intent1.putExtra("selectcategory",selectcategory);
									startActivity(intent1);
									finish();*/
									ConstantUtils.selectcategory=selectcategory;
									ConstantUtils.activityLunch="ScheduledDeliveryActivity";
									showCheckoutDialog();
	...
	{
		adapter = new OfflineCartItemDetailsAdapter(OfflineCartListActivity.this, itemData);
	...
	void doCartItemList()
	{
		final ProgressDialog progressDialog=new ProgressDialog(OfflineCartListActivity.this);
		...
		StringRequest postRequest = new StringRequest(Request.Method.POST, url,
			...
			public void onResponse(String response) {
				...
				new Response.ErrorListener()
				{
					...
					public void onErrorResponse(VolleyError error) {
						...
						Toast.makeText(OfflineCartListActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
					}
				}
				){
			@Override
			...
			{
				userInfo = Sharepreferences.getSharePreferance(OfflineCartListActivity.this);
	...
	public void parseClearResponse(String response){
		...
		try {
			...
			if(Status.equalsIgnoreCase("true")) {
				...
				startActivity(new Intent(OfflineCartListActivity.this,HomeActivity.class));
				finish();
			}else {
	...
	public void addTipDilog(){
		...
		final Dialog dialog = new Dialog(OfflineCartListActivity.this);
	...
	public  void showCheckoutDialog(){
		...
		dialog.setContentView(R.layout.custom_checkout_dialog);
		...
		btnDisplay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(OfflineCartListActivity.this,radioButton.getText(), Toast.LENGTH_SHORT).show();
				if(radioButton.getText().toString().equalsIgnoreCase("New Customer - Register")){

					Bundle bundle = new Bundle();
					bundle.putString("guestOrder", "1");
					Intent intent = new Intent(OfflineCartListActivity.this, CustomerRrgisterActivity.class);
					intent.putExtras(bundle);
					startActivity(intent);
					finish();

				}else if(radioButton.getText().toString().equalsIgnoreCase("Already a Customer - Login")) {

					Bundle bundle = new Bundle();
					bundle.putString("guestOrder", "1");
					Intent intent2 = new Intent(OfflineCartListActivity.this, LoginActivity.class);
					intent2.putExtras(bundle);
					startActivity(intent2);
					finish();

				}else if(radioButton.getText().toString().equalsIgnoreCase("Quick Checkout - No Sign In")){
